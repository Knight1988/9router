...
const USAGE_HANDLERS = {
  ...
  "open-claude": (c) => getOpenClaudeUsage(c.connection, c.onSessionRefreshed),
  ...
  "cc-claudible": (c) => getClaudibleUsage(c.apiKey, c.proxyOptions),
  "cn-claudible": (c) => getClaudibleUsage(c.apiKey, c.proxyOptions),
  "minimax-claudible": (c) => getClaudibleUsage(c.apiKey, c.proxyOptions),
  "claude-claudible": (c) => getClaudibleUsage(c.apiKey, c.proxyOptions),
  "codex-claudible": (c) => getClaudibleUsage(c.apiKey, c.proxyOptions),
