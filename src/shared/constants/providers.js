...
export const APIKEY_PROVIDERS = {
  ...
  "cc-claudible": { id: "cc-claudible", alias: "cc-claudible", name: "CC Claudible", icon: "smart_toy", color: "#D97757", textIcon: "CC", website: "https://claudible.io", notice: { text: "Premium Claude API with smart optimizations. Track usage at dashboard.", apiKeyUrl: "https://claudible.io/dashboard" } },
