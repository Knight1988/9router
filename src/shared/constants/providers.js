...
const BETA_PROVIDERS = {
  techopenclaw: { id: "techopenclaw", alias: "techopenclaw", name: "Techopenclaw", icon: "smart_toy", color: "#D97757", textIcon: "TOC", website: "https://techopenclaw.com", notice: { text: "Vietnamese AI gateway for Claude, GPT, Gemini, and DeepSeek. One API key, multiple models.", apiKeyUrl: "https://techopenclaw.com/dashboard" }, serviceKinds: ["llm"] },
