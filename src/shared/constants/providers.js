...
export const APIKEY_PROVIDERS = {
  ...
  techopenclaw: { id: "techopenclaw", alias: "techopenclaw", name: "Techopenclaw", icon: "smart_toy", color: "#D97757", textIcon: "TOC", website: "https://techopenclaw.com", notice: { text: "Vietnamese AI gateway for Claude, GPT, and Gemini. One API key, multiple models.", apiKeyUrl: "https://techopenclaw.com/dashboard" }, passthroughModels: true, modelsFetcher: { url: "https://api.techopenclaw.com/v1/models", type: "openai-all" }, serviceKinds: ["llm"] },
