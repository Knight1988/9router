...
import { getUserByUsername, setLastLogin } from "@/lib/localDb";
...
export async function POST(request) {
  try {
    ...
    if (user.passwordHash) {
      ...
      // No hash stored (migrated admin with default password, or fresh install)
    ...
    if (isValid) {
      ...
      const mustChangePassword =
        !user.passwordHash && !process.env.INITIAL_PASSWORD && !isLocalRequest(request);
